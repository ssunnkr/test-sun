...
| 2022-05-10 | ☑️ |  | 인공지능과 가위바위보 하기  | #Mnist #Matplotlib #validation, train, test → dataset split #Sequential Model #Sequenetial API#LeNet   | hand.jpg  | 
| 2022-05-12 |  |  | 작사가 인공지능 만들기  | #Mnist #Matplotlib #validation, train, test → dataset split #Sequential Model #Sequenetial API #LeNet  |   |  
